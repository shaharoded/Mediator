...
# DDL Queries
INITIALIZE_TABLES_DDL = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'create_tables.sql')
...
# GET_DATA_BY_PATIENT_QUERY = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'get_data_by_patient.sql')
GET_DATA_BY_PATIENT_CONCEPTS_QUERY = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'get_data_by_patient_and_concepts.sql')
